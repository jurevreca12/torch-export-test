...
if __name__ == "__main__":
    ...
    example_inputs = torch.randn((1, 64), dtype=torch.float32, device="cpu")
    ...
    print("float outputl: ", float_model(example_inputs))
    print("\n\n")
    print("quantized model: ", model)
    print("quantized output: ", model(example_inputs))
